...
def fields(AOI, AOE, wavelengths, thicknesses, henkeFiles, periods, sigma, substrateHenkeFile):
    ...
    r1, t1, r2, t2 = matrixmethod.amplitudes_debeyewaller(n, np.array(wavelengths), np.array(kz_AOI), np.array(kz_AOE), t, sigma)
...
def fields_debeyewaller(AOI, AOE, wavelengths, thicknesses, henkeFiles, periods, sigma, substrateHenkeFile):
    """
    Returns the reflectivity curve of a multilayer.
